...
const googleReviews2 = [
  ...
  {
    quote: <>I can&rsquo;t thank them enough for helping me at my lowest. Broke, homeless, unemployed. The employees are <strong>genuinely helpful</strong>. They want everyone to become a success story.</>,
    author: "Troy"
  },
  {
      ...
      <section className="py-32 bg-gray-50">
        <div className="container max-w-container mx-auto px-8">
          <header className="section-header text-center mb-20">
            ...
            <h2 className="font-display text-display-md font-normal leading-tight tracking-tight text-gray-900 mb-6">You&rsquo;re a client, not a case number.</h2>
            <p className="section-intro text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From the moment you walk through our doors, you&rsquo;re given the full attention of a career specialist who&rsquo;s here to help you succeed.
            </p>
          </header>
