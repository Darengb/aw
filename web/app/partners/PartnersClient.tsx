      ...
      <section className="section py-32 bg-gray-50">
        <div className="container max-w-container mx-auto px-8">
          <header className="section-header text-center mb-24">
            ...
            <h2 className="font-display text-display-md font-normal leading-tight tracking-tight text-gray-900 mb-6">Who we partner with&mdash;and how we help.</h2>
        ...
        <div className="split-content flex items-center p-12 lg:p-20 bg-white">
          <div className="split-content-inner max-w-xl">
            ...
            <p className="split-description text-lg text-gray-600 leading-relaxed mb-8">
              Our programs typically combine work readiness, training, job placement, and retention services into a single integrated pathway&mdash;so participants move as quickly as possible into work while building skills for advancement.
            </p>
        ...
        <div className="container max-w-container mx-auto px-8">
          ...
          <div className="max-w-3xl mx-auto mt-16 p-10 bg-white border-l-4 border-aw-blue">
            <p className="text-xl leading-relaxed text-gray-800 italic mb-4">
              &ldquo;Providers like America Works demonstrated how individualized performance-based contracts could drive stronger engagement and employment outcomes.&rdquo;
            </p>
            <p className="text-sm text-gray-600 font-semibold">
              &mdash; Summary of findings from independent reviews of TANF and workforce contracts
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section py-32 bg-gray-50" id="implementation">
        <div className="container max-w-container mx-auto px-8">
          <header className="section-header text-center mb-24">
            ...
            <p className="section-intro text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              We know every jurisdiction is different. Our implementation approach is collaborative and structured, so you get a partner&mdash;not just a vendor.
            </p>
          </header>
      ...
      <section className="cta-section py-32 bg-gray-950 text-white text-center relative overflow-hidden" id="contact">
        <div className="container max-w-container mx-auto px-8">
          <div className="cta-content relative z-[2]">
            <h2 className="font-display text-display-md font-normal mb-6 tracking-tight">Let&rsquo;s explore what we can build together.</h2>
