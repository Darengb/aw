        ...
        <div className="container max-w-container mx-auto px-8">
          <header className="section-header text-center mb-24">
            ...
            <p className="section-intro text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Hiring shouldn&rsquo;t mean sorting through hundreds of resumes or paying high agency fees. America Works offers a simple alternative: we recruit, screen, and support candidates&mdash;so you can focus on running your business.
            </p>
          </header>
      ...
      <section className="split-section grid grid-cols-1 lg:grid-cols-2 gap-0 items-center min-h-[75vh] relative">
        ...
        <div className="split-content">
          <div className="split-content-inner">
            ...
            <h2 className="split-headline font-display text-4xl font-normal leading-tight tracking-tight text-gray-900 mb-6">Candidates prepared to succeed&mdash;not just to show up.</h2>
            ...
            <p className="split-description text-lg text-gray-600 leading-relaxed mb-8">
              After hire, we stay in touch with your new employee for a period of time&mdash;offering mentoring, guidance, and problem-solving support during and outside of work hours. This reduces early turnover and helps employees stay engaged and dependable.
            </p>
          </div>
        </div>
      </section>
