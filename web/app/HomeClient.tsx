...
const googleReviews2 = [
  ...
  {
    quote: <>I&rsquo;ve learned a lot about myself working with the job trainer and developers. <strong>Highly recommended</strong> for those interested in their job search.</>,
    author: "Mecia"
  },
  {
      ...
      <section className="locations-section py-32 relative bg-gray-50">
        <div className="container max-w-container mx-auto px-8">
          ...
          <div className="section-cta text-center">
            <a href="#contact" className="btn-link inline-flex items-center gap-2 font-body text-sm font-semibold uppercase tracking-wider text-gray-900 no-underline transition-all duration-200 hover:text-aw-blue">Find your local office &rarr;</a>
      ...
      <section className="populations-served py-32 relative bg-white overflow-hidden">
        <div className="container max-w-container mx-auto px-8">
          ...
          <div className="ticket-to-work-badge">
            <div className="badge-icon-large"><Check /></div>
            <div className="badge-content">
              <h3>Official Ticket to Work Provider</h3>
              <p>We&rsquo;re an approved Employment Network, helping Social Security beneficiaries work without losing critical benefits.</p>
            </div>
          </div>
        </div>
      </section>
