...
export default function EventsClient({ events: allEvents }: { events: EventItem[] }) {
    ...
    <div ref={pageRef}>
      ...
      <section className="py-24 bg-gray-950 text-white text-center relative overflow-hidden" id="contact">
        ...
        <div className="max-w-container mx-auto px-8 relative z-10">
          <h2 className="font-display text-display-md font-normal mb-6 tracking-tight">Can&rsquo;t find an event near you?</h2>
