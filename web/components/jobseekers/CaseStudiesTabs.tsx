...
const caseStudies: CaseStudy[] = [
    ...
    content: (
      <>
        ...
        <blockquote className="border-l-3 border-aw-red pl-4 italic text-gray-700 mt-6">
          &ldquo;It was all thanks to you guys, you gave me hope&hellip;and for that I&rsquo;m extremely grateful!&rdquo;
        </blockquote>
      </>
    )
  },
  ...
  },
  {
    ...
    content: (
      <>
        <div className="font-mono text-xs font-bold uppercase tracking-[0.15em] text-aw-blue mb-2">Never Too Late: A Veteran&rsquo;s Story</div>
        <h3 className="font-display text-2xl text-gray-900 mb-4">Johnnie</h3>
        <p className="text-gray-600 leading-relaxed mb-4">
          After many years of being homeless, unemployed and battling addiction, Johnnie proved that it&rsquo;s never too late to start over and was honored by President Barack Obama at the White House.
        </p>
        <p className="text-gray-600 leading-relaxed mb-4">
          Johnnie served his country in the Army overseas. Ten years after his return, substance abuse took over his life. He lost his job, and lived on the streets without work for more than 19-years until he connected with Chicago&rsquo;s Veterans Affairs.
        </p>
        <p className="text-gray-600 leading-relaxed mb-4">
    ...
    content: (
      <>
        ...
        <blockquote className="border-l-3 border-aw-red pl-4 italic text-gray-700 my-6">
          &ldquo;The training here was on a different level. The people here&hellip;genuinely want to help.&rdquo;
        </blockquote>
        <p className="text-gray-600 leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-gray-600 leading-relaxed mb-4">
          Lamont was unable to read and write when he came to America Works. He also didn&rsquo;t have any prior work experience. However, the team did not see any of these circumstances as barriers. Instead, they focused on his potential and strengths &ndash; his work ethic, willingness to learn and dedication to improving himself.
        </p>
        <p className="text-gray-600 leading-relaxed mb-4">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="text-gray-600 leading-relaxed">
          His hard work paid off. He landed a job after his first interview. Not long after, he obtained his permit and now has his driver&rsquo;s license. Owen is well on his way to being self-sufficient and has never looked back.
        </p>
      </>
    )
  }
