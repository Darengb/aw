        ...
        <div className="footer-content grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr] gap-16 mb-16">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links list-none">
              <li className="mb-3"><Link href="/jobseekers" className="text-gray-500 no-underline text-sm transition-colors duration-200 hover:text-white">How It Works</Link></li>
              <li className="mb-3"><Link href="/jobseekers" className="text-gray-500 no-underline text-sm transition-colors duration-200 hover:text-white">Services</Link></li>
              <li className="mb-3"><Link href="/jobseekers" className="text-gray-500 no-underline text-sm transition-colors duration-200 hover:text-white">Success Stories</Link></li>
              <li className="mb-3"><Link href="/jobseekers" className="text-gray-500 no-underline text-sm transition-colors duration-200 hover:text-white">FAQ</Link></li>
            </ul>
          </div>
